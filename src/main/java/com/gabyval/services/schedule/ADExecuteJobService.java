...
@Service
@Transactional
public class ADExecuteJobService extends GabyvalService{

    @Override
    public Object load(Serializable o_id) throws GBPersistenceException {
        return (AdExecuteJob) persistence.load(o_id, AdExecuteJob.class);
    }

    @Override
    public List<Object> getAll() throws GBPersistenceException {
        return persistence.getAll(GBSentencesRBOs.ADEXECUTEJOB_FINDALL);
    }
}
