...
@Service
@Transactional
public class ADSystemControlServices extends GabyvalService{
    
    @Override
    public Object load(Serializable o_id) throws GBPersistenceException {
        return persistence.load(o_id, AdSystemControl.class);
    }

    @Override
    public List<Object> getAll() throws GBPersistenceException {
        return persistence.getAll(GBSentencesRBOs.ADSYSTEMCONTROL_FINDALL);
    }
}
