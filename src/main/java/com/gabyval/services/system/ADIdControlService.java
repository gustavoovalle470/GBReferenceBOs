...
@Service
@Transactional
public class ADIdControlService extends GabyvalService{

    @Override
    public Object load(Serializable o_id) throws GBPersistenceException {
        return (AdIdControl) persistence.load(o_id, AdIdControl.class);
    }

    @Override
    public List<Object> getAll() throws GBPersistenceException {
        return persistence.getAll(GBSentencesRBOs.ADIDCONTROL_FINDALL);
    }
}
