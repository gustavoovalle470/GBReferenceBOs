...
--
-- Table structure for table `ad_job`
--

DROP TABLE IF EXISTS `ad_job`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ad_job` (
  `JOB_ID` int(11) NOT NULL AUTO_INCREMENT,
  `AUTO_RUN` varchar(1) NOT NULL,
  `CREATE_DT` date NOT NULL,
  `EXP_CRON` varchar(50) NOT NULL,
...
--
-- Dumping data for table `ad_job`
--

LOCK TABLES `ad_job` WRITE;
/*!40000 ALTER TABLE `ad_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `ad_job` ENABLE KEYS */;
UNLOCK TABLES;
